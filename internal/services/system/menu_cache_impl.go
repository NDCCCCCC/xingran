...
func (s *menuCacheService) GetTree(ctx context.Context) ([]models.Menu, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		GetMenuTreeKey(false), // 默认不包含隐藏菜单
		s.GetExpiration(services.CacheConfigMenuTree, 30*time.Minute),
		func() ([]models.Menu, error) { return s.queryTree(ctx, false) })
}
...
func (s *menuCacheService) GetTreeWithCache(ctx context.Context, includeHidden bool) ([]models.Menu, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		GetMenuTreeKey(includeHidden),
		s.GetExpiration(services.CacheConfigMenuTree, 30*time.Minute),
		func() ([]models.Menu, error) { return s.queryTree(ctx, includeHidden) })
}
...
func (s *menuCacheService) GetRouterDataWithCache(ctx context.Context) ([]models.Menu, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		CacheKeyMenuRouter,
		s.GetExpiration(services.CacheConfigMenuRouter, 30*time.Minute),
		func() ([]models.Menu, error) { return s.queryRouterData(ctx) })
}
...
func (s *menuCacheService) GetUserMenus(ctx context.Context, userID string) ([]models.Menu, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		GetMenuUserMenusKey(userID),
		s.GetExpiration(services.CacheConfigMenuTree, 30*time.Minute),
		func() ([]models.Menu, error) { return s.menuService.GetUserMenus(ctx, userID) })
}
...
func (s *menuCacheService) GetAllUserMenus(ctx context.Context, userID string) ([]models.Menu, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		GetMenuUserAllMenusKey(userID),
		s.GetExpiration(services.CacheConfigMenuTree, 30*time.Minute),
		func() ([]models.Menu, error) { return s.menuService.GetAllUserMenus(ctx, userID) })
}
...
func (s *menuCacheService) GetUserPermissions(ctx context.Context, userID string) ([]string, error) {
	return base.GetOrSetJSON(ctx, s.cache,
		GetMenuUserPermissionsKey(userID),
		s.GetExpiration(services.CacheConfigMenuTree, 30*time.Minute),
		func() ([]string, error) { return s.menuService.GetUserPermissions(ctx, userID) })
}
...
func InvalidateUserMenuCacheByProvider(ctx context.Context, cache CacheProvider) {
	base.InvalidatePattern(ctx, cache, userMenuCacheInvalidationPatterns(), "MENU-USER")
}
