...
import type { UserPreferences, ThemeConfiguration, LayoutConfiguration, DataConfiguration } from "@/types/config";
...
export const selectDefaultPageSize = (state: SettingsStore) => state.preferences.data.defaultPageSize;
