  ...
  return (
    <>
      ...
      >
        ...
        {isEditable && isSelected && (
          <div className="grid-item__actions">
            <Space size="small">
              ...
              <Button danger size="small" icon={<DeleteOutlined />} onClick={handleRemove}>
                删除
              </Button>
            </Space>
          </div>
        ...
        <div className="grid-item__content">{children}</div>
      </div>
...
export const GridItemPlaceholder: React.FC<{
  ...
  return (
    <div className="grid-item-placeholder" onClick={onClick} data-widget-id={widgetId}>
