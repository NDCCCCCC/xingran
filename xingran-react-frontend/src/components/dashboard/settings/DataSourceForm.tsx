 ...
 */
const extractConfig = <T extends DataSourceConfig>(type: DataSourceType, config?: DataSourceConfig): T | null => {
...
export const DataSourceForm: React.FC<DataSourceFormProps> = ({
	...
	const [dataSourceType, setDataSourceType] = useState<DataSourceType>(() => getDataSourceType(value));
