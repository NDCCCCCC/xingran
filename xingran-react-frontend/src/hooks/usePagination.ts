...
export function usePagination(options: UsePaginationOptions = {}): UsePaginationReturn {
	...
	const fallbackPageSize = options.pageSize
		?? preferences?.data?.defaultPageSize
		?? 10;
	...
	const [persistedPageSize, setPersistedPageSize, resetPageSize] = usePersistedStateController<number>({
		keyPrefix: location.pathname,
		keySuffix: "pageSize",
