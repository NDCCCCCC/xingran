...
const ExecutionManagement: FC = () => {
  ...
  const {
    orderByColumn,
    isAsc,
    handleTableChange: handleExecSortChange,
    sortOrder: execSortOrder,
  } = useServerSort<Execution>({
    sorterMetas,
  });
  ...
  const columns = useMemo(
    () =>
      getExecutionColumns({
        handleViewDetail,
        getSortOrder: (field) =>
          orderByColumn === field ? ((execSortOrder ?? null) as "ascend" | "descend" | null) : null,
      }),
