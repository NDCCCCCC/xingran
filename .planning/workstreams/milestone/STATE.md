...
status: executing
stopped_at: Completed Phase 78 — BLOCK-03 + BLOCK-04 清零,BLOCK-05 差 12pp(LDAP BER 不兼容留 Phase 79),SC#1-2+4-5 全绿
last_updated: "2026-08-27T21:10:00.000Z"
...
**Created**: 2026-04-16
**Status**: **v1.26 后端测试覆盖率优秀 SHIPPED 2026-08-22 (Phases 71-74 / 4 phases / 34 plans / Phase 74 SHIPPED)** — weighted avg 12.8% → 55.5% (ratchet chain 12.8→21.5→25.9→55.5), 0%-pkg 33 → 5 (SC-b met), P1 8/8 ≥70% floor + P2 7/10 at 70% floor + 3 UP-ONLY ratcheted (core 38.33 / device 39.07 / agent-server 22.08, structural blocks documented in 74-08-SUMMARY), GOV-03 PR diff coverage ≥80% gate live (74-10), SC-a shortfall honestly documented (55.56% vs 70% target — see 74-MILESTONE-AUDIT.md). 此前: v1.22 + v1.23 + v1.24 + v1.25 启动块 + Phase 63 全部 SHIPPED(Phases 63-70 / 8 phases / 21 plans / 36 requirements 100% 勾选 / 33+ tasks)。**Phase 63** 前端工具链自动化 SHIPPED 2026-08-20(1/1 plan,5/5 SC verified,7-commit chain `760606a..937f35f`,含 `d2184fd` Phase 70 格式回归修复)。**v1.23 启动块**: Phase 68 部署稳健性 & 文档一致性(SM2 密钥配置闭环)EXECUTED 2026-08-19(5 commits: a21dcec..25ded8f)。**v1.24 启动块**: Phase 69 字典与状态值治理 8/8 plans EXECUTED 2026-08-19(DICT-01 后端常量终态 + DICT-02 字典 seed 11 组 + DICT-03 前端 4 页 useDict 迁移 + DICT-04 CLAUDE.md 指针化)。**v1.25 启动块**: Phase 70 系统设置页面布局重构 7/7 plans EXECUTED 2026-08-19(D-01~D-12 全部勾选,visual gate 通过,e138411 收口)。
...
|-------|------|----------|-------|
| Phase 75 P04 | 35m | 3 tasks | 6 files; fix(quirk-10) 46c1485 + fix(quirk-13) 2b6b7d1 (Q-12 merged due to concurrent executor HEAD reset); docs(75-04) 40965fb/939e3ae (accidentally included frontend-coverage staged files); build + go test ./... + check-ci-local.sh backend --no-npm-ci 全绿; 2 deviations documented |
