...
- [x] **Phase 87: P2 页面层 R3 — 剩余全部页面** - duty / ad-domain / monitor / vdi / workorder / asset / knowledge / dashboard-system / my-notices / login + 零散页收清，全局首达 ≥70% (completed 2026-08-27)
...
- [x] 83-03-lib-coverage-PLAN.md — lib 层 1042 stmts 测试补齐至 ≥70%（含 api.ts 双轨直测），bump lib floor
...
- [x] 83-05-services-router-harness-PLAN.md — services/router/constants/types 收尾 ≥70% + 测试公共 harness 定稿
...
| 87. P2 页面层 R3 — 剩余全部页面 | 1/1 | Complete    | 2026-08-27 |
